...
var color-button = document.getElementById('color-button');

// 2. Write a function, named changeColor, that is called when #color-button is clicked

color-button.onclick(changeColor);
...
var green = document.getElementById('red').value
var blue = document.getElementById('red').value
}
